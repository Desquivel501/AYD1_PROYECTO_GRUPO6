...
export const MenuProducto = (props) => {
  ...
  const eliminar = (event) => {
    postData({endpoint:"EliminarProducto",data:{
      correo: user.id, producto: id
    }})
      .then((response) => {
  ...
  const handleSubmit = (event) => {
    ...
    console.log(data);
    sendFormData({
      endpoint: (edicion ? "EditarProducto" : "CrearProducto"),
      data,
    })
      .then((response) => {
                    ...
                    <>
                      ...
                      <FormGroup>
                        <FormControlLabel
                          ...
                          label="Disponible"
                          checked={disponible_}
                          onChange={(event) => setDisponible(!disponible_)}
                        />
                      </FormGroup>
                    </>
                  )}
