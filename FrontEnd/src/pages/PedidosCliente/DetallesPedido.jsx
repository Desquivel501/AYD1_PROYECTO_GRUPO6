                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <IconButton
                            aria-label="delete"
                            onClick={(event) => setCalificacion(1)}
                          >
                            {calificacion >= 1
                              ? (
                                <StarIcon
                                  sx={{ fontSize: 50, color: "#ffcc00" }}
                                />
                              )
                              : (
                                <StarOutlineIcon
                          ...
                          <IconButton
                            aria-label="delete"
                            onClick={(event) => setCalificacion(2)}
                          >
                            {calificacion >= 2
                              ? (
                                <StarIcon
                          ...
                          <IconButton
                            aria-label="delete"
                            onClick={(event) => setCalificacion(3)}
                          >
                            {calificacion >= 3
                              ? (
                                <StarIcon
                          ...
                          <IconButton
                            aria-label="delete"
                            onClick={(event) => setCalificacion(4)}
                          >
                            {calificacion >= 4
                              ? (
                                <StarIcon
                          ...
                          <IconButton
                            aria-label="delete"
                            onClick={(event) => setCalificacion(5)}
                          >
                            {calificacion >= 5
                              ? (
                                <StarIcon
                          ...
                          <Collapse in={open} timeout="auto" unmountOnExit>
                            {pedido.productos.map((item, i) => (
                              <ProductCard3
                                ...
                                cost={item.precio}
                                image={item.Combo
                                  ? "https://www.freeiconspng.com/thumbs/promotion-icon-png/leistungen-promotion-icon-png-0.png"
                                  : item.imagen}
                            ...
                            {pedido.cupon != null &&
                              (
                                <ProductCard3
                                  ...
                                  cantidad={0}
                                  coupon={true}
                                  discount={pedido.cupon.porcentaje *
                                    ((pedido.costo) /
                                      (1 - pedido.cupon.porcentaje))}
                                />
                              )}
                      ...
                      >
                        ...
                        <Collapse in={open2} timeout="auto" unmountOnExit>
                          ...
                          <TextField
                            ...
                            label="Forma de pago"
                            name="forma"
                            value={pedido.numero_tarjeta == null
                              ? "Efectivo"
                              : "Tarjeta"}
                          />
                          ...
                          {pedido.numero_tarjeta != null &&
                            (
                              <TextField
                                ...
                                name="cc"
                                value={"**** ***** **** " +
                                  pedido.numero_tarjeta.toString().substr(-4)}
                              />
                            )}
